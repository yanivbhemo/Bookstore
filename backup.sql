...
INSERT INTO `employees` VALUES (1,716268525,'Harry','potter','hpotter@gmail.com','hashnaim 22, rishon'),(2,111222333,'Gary','Oldman','gtheman@walla.com','Hatamar 19, tel aviv'),(3,222333444,'Bradly','Cooper','berad@gmail.com','Hakukia 20, Rahanana');
...
CREATE TABLE `transactions` (
  ...
  KEY `employee_numpk_1_idx` (`employee_num`),
  CONSTRAINT `customer_id` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `employee_numpk_1` FOREIGN KEY (`employee_num`) REFERENCES `employees` (`employee_num`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `transactions` VALUES (1,'2018-03-08',137911773,0,224,4,1),(2,'2017-09-09',219433739,20,144,5,2),(3,'2017-12-27',306466242,17,57,4,2),(4,'2017-03-09',219433739,10,93,4,2),(5,'2017-12-30',137911773,10,93,4,3),(6,'2017-01-01',137911773,0,93,4,3);
...
-- Dump completed on 2018-08-05 15:54:10
